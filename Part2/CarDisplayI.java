...
interface CarDisplayI {
    ...
    // Register a car for driving and visual appearance. Also enables collision
    // detection.
    public void register(CarI car);

    // Deregister a car. Will no longer be seen on the playground and cannot collide
    // with
    // other cars. Any movement is ceased. May be re-registered and will continue
    // from
    ...
    // Get position right before barrier line for Car no. (on private part of
    // track).
